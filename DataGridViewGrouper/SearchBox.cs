...
{
    internal abstract partial class SearchBoxBase : UserControl, ISupportInitialize
    {
    ...
    internal abstract class SourceSearchBox : SearchBoxBase
    {
        #region props
    ...
    internal class BindingSourceSearchBox : SourceSearchBox
    {
    ...
    internal class DataGridSearchBox : SourceSearchBox
    {
        DataGridView grid;
        [DefaultValue(null)]
    ...
    internal class TreeviewSearchBox : SearchBoxBase
    {
        TreeNode lastnode;
    ...
    internal class ToolstripSearchBox<CT> : ToolStripControlHost,ISupportInitialize
    ...
    internal class ToolStripSourceSearchBox<CT> : ToolstripSearchBox<CT>
    ...
    /// </summary>
    internal class ToolstripBindingSourceSearchBox:ToolStripSourceSearchBox<BindingSourceSearchBox>
    {
        [DefaultValue(null)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    internal class ToolstripDataGridSearchBox : ToolStripSourceSearchBox<DataGridSearchBox>
    {
    ...
    internal class ContextMenuStripButton : Control
    {
        bool down;
